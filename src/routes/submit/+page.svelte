...
<main class="subcontainer">
  ...
  <div class="card">
    <h1 class="h1" style="text-align: center;">The submissions will be available after <text style="font-size: larger;">17th</text> of November</h1>
    <p style="text-align: center;">Any submissions before the end of November will be evaluated until the <strong>5th</strong> of December</p>
    <!-- <iframe 
  ...
  <div class="card">
    <h1 class="h1" style="color: #3979c0">Submission process</h1>
      ...
      <ol style="display: grid; gap: 10px">
        ...
        <li> <b>Submit your motion data and write a technical report:</b> Send your motion data to us, through this submission form. In order for your submission to be included on the leaderboard, you have to commit to writing a technical report about your submission, including but not limited to details about data, model architecture, training methods and generation process.</li>
        <li> <b>We will get back to you within a few days, confirming whether we can commit to evaluating your future submission.</b></li>
      </ol>
