...
const SubmitSeamlessPage: React.FC = () => {
  const GOOGLE_FORM_EMBED_URL = 'https://docs.google.com/forms/d/e/1FAIpQLSfvoQAhG6hOaxiJQDU38DId1pFP1aZ0B89nh64uBUUhmQyKAA/viewform?&embedded=true';
  return (
    <div className="mx-auto space-y-8">
          ...
          <div className="bg-blue-50 border border-blue-100 text-blue-900 px-6 py-5 rounded-xl flex gap-4 items-start">
            ...
            <div className="space-y-2">
              ...
              <p className="text-blue-800">
                Submissions are reviewed on a monthly basis. After each monthly submission deadline, the evaluation results are published approximately two weeks later.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-brand-surface p-8 rounded-2xl shadow-lg border border-gray-200">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h2 className="text-3xl font-bold text-brand-text">Rules of the Seamless Leaderboard</h2>
        </div>

        <Par>
          <strong>Please ensure that you have read these rules before submitting to the Seamless Leaderboard. By submitting to the leaderboard, you agree to fully comply with these rules.</strong>
        </Par>

        <SectionTitle icon={<Shield className="w-6 h-6" />}>Goal of the Leaderboard</SectionTitle>
        <Par>
          The GENEA Leaderboard seeks to advance scientific knowledge relating to automatic gesture generation, by means of open science and large-scale, best-practices human evaluations. It is not a competition, and the point is not to find who does best, but what works best. The rules of the leaderboard have been designed with the intent of best furthering this goal.
        </Par>
...
export default SubmitSeamlessPage;
